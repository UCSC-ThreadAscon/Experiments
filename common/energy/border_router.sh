...
output_file_path="$HOME/Desktop/Repositories/Experiments/energy/queue/energy-BR-$cipher_string-$txpower_string.txt"
...
border_router_path=$HOME/Desktop/Repositories/br_energy/examples/basic_thread_border_router
