...
FTD_COMMIT=dde9d2d2e930ec125d3bfb2825190a1a441682e1

# The commit ID of the Delay Server.
DELAY_SERVER_COMMIT=4796a35e95ee1aa8e48203a81acea84a92051dd3

# The commit ID of the Delay Client.
DELAY_CLIENT_COMMIT=8e5604c27e6be1cf7fe4e0face17fc0a9521c0ee

# The commit ID of the Border Router.
BORDER_ROUTER_COMMIT=a7ffd0a2df556375da56f86a36a28783978de18c
